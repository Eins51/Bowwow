...
<div class="mdui-drawer-body-left" id="body" >
    ...
    <div class="margin" id="page_style">
        <div class="operation clearfix">
            ...
            <span class="submenu"><a href="addcategory.php" style ="margin-left:5%;"class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-amber-100" title="Add Category"><i class="fa  fa-edit"></i>&nbsp;Add Category</a></span>
      ...
      <th width="30%">Operation</th>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td width="20%"><img src="./category_img/'.$row['image_path'].'"alt="'.$row['image_path'].'"width="100px"height="100px"></td>';
                            ...
                            echo '<a href="Delete.php?id='.$row['id'].'&cate=category">Delete</a></td>';
                            echo "</tr>";
                            echo "</table>";
                        }
                        echo "</table>";
